...
def main():
    ...
    class MyWindow(QtWidgets.QMainWindow):
        ...
        def patternBox(self):
            ...
            init5 = 20
            self.L_p5_horizon.setGeometry(750,init5,370,25)
            self.L_p5_min_propdif_edge_rsilow1.setGeometry(750,init5+33*1,370,25)
            self.L_p5_min_propdif_rsilow1_rsicandle0.setGeometry(750,init5+33*2,370,25)
            self.L_p5_min_difrsi_rsilow1_rsicandle0.setGeometry(750,init5+33*3,370,25)
            self.L_p5_max_difrsi_rsilow1_rsicandle0.setGeometry(750,init5+33*4,370,25)
            self.L_p5_min_rsilow1.setGeometry(750,init5+33*5,370,25)
            self.L_p5_max_rsilow1.setGeometry(750,init5+33*6,370,25)
            self.L_p5_min_propdif_rsilow1_rsilow2.setGeometry(750,init5+33*7,370,25)
            self.L_p5_min_propdif_rsilow2_rsicandle0.setGeometry(750,init5+33*8,370,25)
            self.L_p5_min_difrsi_rsilow1_rsilow2.setGeometry(750,init5+33*9,370,25)
            self.L_p5_max_difrsi_rsilow1_rsilow2.setGeometry(750,init5+33*10,370,25)
            self.L_p5_min_rsilow2.setGeometry(750,init5+33*11,370,25)
            self.L_p5_max_rsilow2.setGeometry(750,init5+33*12,370,25)
            self.L_p5_min_candledif_rsilow1_rsilow2.setGeometry(750,init5+33*13,370,25)
            self.L_p5_min_propdif_rsilow1_rsihigh.setGeometry(750,init5+33*14,370,25)
            self.L_p5_min_propdif_rsihigh_rsilow2.setGeometry(750,init5+33*15,370,25)
            self.L_p5_min_difrsi_rsihigh_rsilow2.setGeometry(750,init5+33*16,370,25)
            self.L_p5_max_difrsi_rsihigh_rsilow2.setGeometry(750,init5+33*17,370,25)
            ...
            self.E_p5_horizon.setGeometry(1100,init5,100,25)
            self.E_p5_min_propdif_edge_rsilow1.setGeometry(1100,init5+33*1,100,25)
            self.E_p5_min_propdif_rsilow1_rsicandle0.setGeometry(1100,init5+33*2,100,25)
            self.E_p5_min_difrsi_rsilow1_rsicandle0.setGeometry(1100,init5+33*3,100,25)
            self.E_p5_max_difrsi_rsilow1_rsicandle0.setGeometry(1100,init5+33*4,100,25)
            self.E_p5_min_rsilow1.setGeometry(1100,init5+33*5,100,25)
            self.E_p5_max_rsilow1.setGeometry(1100,init5+33*6,100,25)
            self.E_p5_min_propdif_rsilow1_rsilow2.setGeometry(1100,init5+33*7,100,25)
            self.E_p5_min_propdif_rsilow2_rsicandle0.setGeometry(1100,init5+33*8,100,25)
            self.E_p5_min_difrsi_rsilow1_rsilow2.setGeometry(1100,init5+33*9,100,25)
            self.E_p5_max_difrsi_rsilow1_rsilow2.setGeometry(1100,init5+33*10,100,25)
            self.E_p5_min_rsilow2.setGeometry(1100,init5+33*11,100,25)
            self.E_p5_max_rsilow2.setGeometry(1100,init5+33*12,100,25)
            self.E_p5_min_candledif_rsilow1_rsilow2.setGeometry(1100,init5+33*13,100,25)
            self.E_p5_min_propdif_rsilow1_rsihigh.setGeometry(1100,init5+33*14,100,25)
            self.E_p5_min_propdif_rsihigh_rsilow2.setGeometry(1100,init5+33*15,100,25)
            self.E_p5_min_difrsi_rsihigh_rsilow2.setGeometry(1100,init5+33*16,100,25)
            self.E_p5_max_difrsi_rsihigh_rsilow2.setGeometry(1100,init5+33*17,100,25)
