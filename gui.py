...
def main():
    ...
    class MyWindow(QtWidgets.QMainWindow):
        ...
        def patternBox(self):
            ...
            init5 = 20
            self.L_p5_horizon.setGeometry(800,init5,270,25)
            self.L_p5_min_propdif_edge_rsilow1.setGeometry(800,init5+33*1,270,25)
            self.L_p5_min_propdif_rsilow1_rsicandle0.setGeometry(800,init5+33*2,270,25)
            self.L_p5_min_difrsi_rsilow1_rsicandle0.setGeometry(800,init5+33*3,270,25)
            self.L_p5_max_difrsi_rsilow1_rsicandle0.setGeometry(800,init5+33*4,270,25)
            self.L_p5_min_rsilow1.setGeometry(800,init5+33*5,270,25)
            self.L_p5_max_rsilow1.setGeometry(800,init5+33*6,270,25)
            self.L_p5_min_propdif_rsilow1_rsilow2.setGeometry(800,init5+33*7,270,25)
            self.L_p5_min_propdif_rsilow2_rsicandle0.setGeometry(800,init5+33*8,270,25)
            self.L_p5_min_difrsi_rsilow1_rsilow2.setGeometry(800,init5+33*9,270,25)
            self.L_p5_max_difrsi_rsilow1_rsilow2.setGeometry(800,init5+33*10,270,25)
            self.L_p5_min_rsilow2.setGeometry(800,init5+33*11,270,25)
            self.L_p5_max_rsilow2.setGeometry(800,init5+33*12,270,25)
            self.L_p5_min_candledif_rsilow1_rsilow2.setGeometry(800,init5+33*13,270,25)
            self.L_p5_min_propdif_rsilow1_rsihigh.setGeometry(800,init5+33*14,270,25)
            self.L_p5_min_propdif_rsihigh_rsilow2.setGeometry(800,init5+33*15,270,25)
            self.L_p5_min_difrsi_rsihigh_rsilow2.setGeometry(800,init5+33*16,270,25)
            self.L_p5_max_difrsi_rsihigh_rsilow2.setGeometry(800,init5+33*17,270,25)
